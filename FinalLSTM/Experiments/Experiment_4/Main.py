...
MODEL_CONFIGS = [
    ...
    # ),
    # dict(
    #    name            = "Only Hidden (Cell Proj) - No Ramp",
    #    module_dir      = "Model_4",
    #    dataset_path    = "data/dataset.pt",
    ...
    dict(
        ...
        module_dir="Model_3",
        dataset_path="data/dataset.pt",
        model_save_path="Model_3/reliabilty/model90.pt",
        conformal_alpha=0.1,
        epochs=20,
        patience=5,
    ),
    dict(
       ...
       module_dir      = "Model_3",
       dataset_path    = "data/dataset.pt",
       model_save_path = "Model_3/reliabilty/model70.pt",
       conformal_alpha = 0.3,
       epochs          = 20,
       patience = 5,
    ),
    dict(
        ...
        module_dir="Model_3",
        dataset_path="data/dataset.pt",
        model_save_path="Model_3/reliabilty/model50.pt",
        conformal_alpha=0.5,
        epochs=20,
        patience=5,
    ),
    dict(
        ...
        module_dir="Model_3",
        dataset_path="data/dataset.pt",
        model_save_path="Model_3/reliabilty/model30.pt",
        conformal_alpha=0.7,
        epochs=20,
        patience=5,
    ),
    dict(
        ...
        module_dir="Model_3",
        dataset_path="data/dataset.pt",
        model_save_path="Model_3/reliabilty/model10.pt",
        conformal_alpha=0.9,
        epochs=20,
        patience=5,
    ),
