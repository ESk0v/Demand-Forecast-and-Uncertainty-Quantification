...
| Property | Value |
|---|---|
| Model file | `model_decoupled.pt` |
| Best checkpoint epoch | 5 |
| Best validation loss (GaussianNLL) | 0.023788 |
| Total samples | 52080 |
| Train split | 34720 (66.7%) |
| Validation split | 8680 (16.7%) |
| Test split | 8680 (16.7%) |
...
- All metrics are computed on the **test set only** (8680 samples, 16.7%
