...
class LSTMForecast(nn.Module):
    ...
    def forward(self, encoder_input, decoder_input):
        ...
        num_unc_layers = self.uncertaintyDecoderLstm.num_layers  # 2
        unc_hidden = unc_hidden.expand(num_unc_layers, -1, -1).contiguous()
        unc_cell   = unc_cell.expand(num_unc_layers, -1, -1).contiguous()
