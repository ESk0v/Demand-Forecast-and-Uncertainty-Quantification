...
and saves synthetic_data_1 + evaluation plots for each model.
"""
...
MODEL_CONFIGS = [
    ...
    # ),
    # dict(
    #    name = "Model 8, Fix early horizon",
    #    module_dir = "Model_8",
    #    dataset_path = "data/dataset.pt",
    #    model_save_path = "Model_8/synthetic_data_1/model.pt",
    #    conformal_alpha = 0.10,
    #    epochs = 50,
    #    patience = 5,
    #    training_variant = "decoupled",
    ...
    #     module_dir = "Model_9",
    #     dataset_path = "data/dataset.pt",
    #     model_save_path = "Model_9/synthetic_data_1/model.pt",
    #     conformal_alpha = 0.10,
    #     epochs = 50,
    #     patience = 5,
    #     training_variant = "decoupled",
