...
| Property | Value |
|---|---|
| Model file | `model_v51.pth` |
| Best checkpoint epoch | 106 |
| Best validation loss (GaussianNLL) | 0.004897 |
| Total samples | 87264 |
| Train split | 52360 (60.0%) |
| Validation split | 17452 (20.0%) |
| Test split | 8726 (10.0%) |
...
- All metrics are computed on the **test set only** (8726 samples, 10.0%
